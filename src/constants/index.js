...
export const INIT_ACCEPTOR_CAREER_HISTORY = 'INIT_ACCEPTOR_CAREER_HISTORY';

export const ADDED_ACCEPTOR_CAREER = 'ADDED_ACCEPTOR_CAREER';

export const DELETED_ACCEPTOR_CAREER = 'DELETED_ACCEPTOR_CAREER';

export const INIT_ACCEPTOR_RECORD = 'INIT_ACCEPTOR_RECORD';

export const ADDED_ACCEPTOR_RECORD = 'ADDED_ACCEPTOR_RECORD';

export const DELETED_ACCEPTOR_RECORD = 'DELETED_ACCEPTOR_RECORD';
...
export const ADDED_ZXJ_APPLY = 'ADDED_ZXJ_APPLY';

export const ZXJ_APPLY_LIST_FETCHED = 'ZXJ_APPLY_LIST_FETCHED';
